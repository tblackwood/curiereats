        ...
        if request.POST.get('step') == '1':
            ...
            if step3_form.is_valid():
                ...
                try:
                    ...
                    creating_job.price = creating_job.distance * 1
                    creating_job.save()
                    
                except Exception as e:
                    print(e)
                    messages.error(requests, "Unfortunately, we don't support shipping at this distance")
            ...
            if creating_job.price:
                try:
                    ...
                    print(settings.NOTIFICATION_URL)
