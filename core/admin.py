...
class TransactionAdmin(admin.ModelAdmin):
    list_display=['stripe_payment_intent_id','customer','courier','courier_paypal_email','job','amount', 'status', 'created_at']
    list_filter = ['status',]
...
class JobAdmin(admin.ModelAdmin):
    list_display = ['name', 'category','status','customer', 'courier', 'size', 'price']
